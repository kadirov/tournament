...
<table class="table table-striped ">
    <?php foreach ($matchResults as $mr) :?>
        ...
        <?php elseif ($mr->getGroup() !== null && $lastGroup !== $mr->getGroup()) : ?>
            <tr>
        ...
        <tr>
            <th width="1%"
                class="<?= $mr->isFirstTeamWon() ? 'success' : '' ?> <?= $mr->isSecondTeamWon() ? 'danger' : '' ?>">
            ...
            <th width="48%">
                ...
                <span class="text-muted text-info" style="font-weight: normal">
                    ...
                    <?= $mr->getAdditionalTimesScore() === null ?
                        '' :
                        '<br>Additional times result<br>Second time result' ?>
                </span>
            </th>
            <td>
                ...
                <span class="text-muted text-info" style="font-weight: normal">
                    <?= $mr->getPenaltiesScore() === null ?
                        '' : '<br>' . $mr->getPenaltiesScore()->getFirstTeamScore() . ' :
                         ' . $mr->getPenaltiesScore()->getSecondTeamScore() ?>
                    <?= $mr->getAdditionalTimesScore() === null ?
                        '' : '<br>' . $mr->getAdditionalTimesScore()->getFirstTeamScore() . ' :
                         ' . $mr->getAdditionalTimesScore()->getSecondTeamScore() ?>
                    <?= $mr->getAdditionalTimesScore() === null ?
                        '' : '<br>' . $mr->getSecondTimeScore()->getFirstTeamScore() . ' :
                         ' . $mr->getSecondTimeScore()->getSecondTeamScore() ?>
                </span>
            </td>
            <th class="text-right">
                <?= $mr->getTeam2()->getName() ?>
            ...
            <th width="1%"
                class="<?= $mr->isSecondTeamWon() ? 'success' : '' ?>
                <?= $mr->isFirstTeamWon() ? 'danger' : '' ?>">
            </th>
        </tr>
    <?php endforeach ?>
</table>
